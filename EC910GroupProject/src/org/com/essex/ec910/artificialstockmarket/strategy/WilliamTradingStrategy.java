 ...
 * @author WEIGUANG MAO
 * buy share when price achieve the average price
 * sell shares when price is higher than the average price 2%
 */
		...
		if(prices != null)
		{
			...
			if(prices.length >= period)
			{
				...
				if(retCode == RetCode.Success)
				{
					...
					{
						//Buy as much as possible if price is close to moving average
